...
class SideBarCated extends Component {
    constructor(props) {
        super(props);
    }
                ...
                <div className="nav-wrapper">
                    <ul className="nav--no-borders flex-column nav">
                        <li className="nav-item">
                            <NavLink to="/catedHome" exact className="nav-link " activeClassName={'active'}>
                        ...
                        <li className="nav-item">
                            <NavLink to="/gestCursosCatedList" className="nav-link" activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
